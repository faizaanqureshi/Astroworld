...
public class Astroworld extends PApplet {
...
public void setup() {
  ...
  rodeo_live = new imgbutton(rodeo, width / 2 + width / 6, height / 2, width / 1.92f, height / 1.8f);
...
public void draw() {
  if (lightmode == false) {
    nextbutton = new imgbutton(next, width / 1.1497006f, height / 2, width / 38.4f, height / 21.6f);
    previousbutton = new imgbutton(previous, width / 1.1497006f, height / 2, width / 38.4f, height / 21.6f);
    background(0);
  } else if (lightmode == true) {
    nextbutton = new imgbutton(next_lightmode, width / 1.1497006f, height / 2, width / 38.4f, height / 21.6f);
    previousbutton = new imgbutton(previous_lightmode, width / 1.1497006f, height / 2, width / 38.4f, height / 21.6f);
    background(255);
  }
  strokeWeight(0);
  song_count.clear();
  ...
  if (screen == 2) { //MUSIC PLAYER MAIN PAGE
    ...
    if (pagenum == 1) {
      ...
      live_album.render();
      textSize(width / 128);
      text("Live Performances", width / 2.4f, height / 3.32f);
  ...
  if (screen == 11) { //LIVE PERFORMANCES
    ...
    backbutton.render();
    nowplaying.render();
    image(live, a1.x, height / 6.96f, width / 12.8f, height / 7.2f);
    rodeo_live.render();
  }
...
public void movieEvent(Movie rodeo) {
  rodeo.read();
}
...
public void mousePressed() {
  ...
  if (mouseButton == RIGHT && screen == 11) {
    if (imageisClicked(rodeo_live) && fullscreen == false) {
      ...
      rodeo_live.y = height / 2;
      rodeo_live.b = width / 1.92f;
      rodeo_live.h = height / 1.8f;
      fullscreen = false;
    }
  }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--hide-stop", "Astroworld" };
    if (passedArgs != null) {
